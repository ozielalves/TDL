...
import LogoWrapper from './LogoWrapper.svelte'
...
export const todos = writable([
	...
	{userId: 1, id: 3, title: 'Todo3', completed: false},
	{userId: 1, id: 4, title: 'Todo4', completed: false},
	{userId: 1, id: 5, title: 'Todo5', completed: false},
]);
...
#intro .hoveredCircle {
 -webkit-animation: dance 0.8s ease-in-out;
...
#intro #mt1 {
 ...
 top: 11%;
 z-index: 1;
 -webkit-animation: goAway 15s ease-in-out infinite;
...
#intro #mt2 {
 ...
 top: 13%;
 z-index: 1;
 -webkit-animation: goAway 20s ease-in-out infinite;
...
#intro #mt3 {
 ...
 top: 58%;
 z-index: 1;
 -webkit-animation: goAway 10s ease-in-out infinite;
...
#intro #mt4 {
 ...
 top: 80%;
 z-index: 1;
 -webkit-animation: goAwayReduced 10s ease-in-out infinite;
...
@-webkit-keyframes goAwayReduced {
 0% {
	 -webkit-transform: translatex(0%);
					 transform: translatex(0%);
 }
